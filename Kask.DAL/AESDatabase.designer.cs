...
namespace Kask.DAL.Models
{
    ...
    partial void InsertMCOption(MCOption instance);
    partial void UpdateMCOption(MCOption instance);
    partial void DeleteMCOption(MCOption instance);
    ...
    partial void InsertSAQuestion(SAQuestion instance);
    partial void UpdateSAQuestion(SAQuestion instance);
    partial void DeleteSAQuestion(SAQuestion instance);
    partial void InsertSAResponse(SAResponse instance);
    partial void UpdateSAResponse(SAResponse instance);
    partial void DeleteSAResponse(SAResponse instance);
    ...
    partial void DeleteAssessment(Assessment instance);
		...
		public System.Data.Linq.Table<MCOption> MCOptions
		{
			get
			{
				return this.GetTable<MCOption>();
			}
		}
		...
		public System.Data.Linq.Table<SAQuestion> SAQuestions
		{
			get
			{
				return this.GetTable<SAQuestion>();
			}
		}
		
		public System.Data.Linq.Table<SAResponse> SAResponses
		{
			get
			{
				return this.GetTable<SAResponse>();
			}
		}
    ...
    partial void OnNameAliasChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Applicant_Interview", Storage="_Interviews", ThisKey="Applicant_ID", OtherKey="Applicant_ID")]
    ...
    partial void OnUserIDChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="UserProfile_Interview", Storage="_UserProfile", ThisKey="UserID", OtherKey="UserId", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public UserProfile UserProfile
		{
			get
			{
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.MCOptions")]
	public partial class MCOption : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private string _MCOptionDescription;
		
		private EntitySet<QuestionBank> _QuestionBanks;
    ...
    partial void OnMCOptionDescriptionChanging(string value);
    partial void OnMCOptionDescriptionChanged();
    #endregion
		
		public MCOption()
		{
			this._QuestionBanks = new EntitySet<QuestionBank>(new Action<QuestionBank>(this.attach_QuestionBanks), new Action<QuestionBank>(this.detach_QuestionBanks));
			OnCreated();
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_MCOption_ID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_MCOptionDescription", DbType="VarChar(255) NOT NULL", CanBeNull=false)]
		public string MCOptionDescription
		{
			get
			{
				return this._MCOptionDescription;
			}
			set
			{
				if ((this._MCOptionDescription != value))
				{
					this.OnMCOptionDescriptionChanging(value);
					this.SendPropertyChanging();
					this._MCOptionDescription = value;
					this.SendPropertyChanged("MCOptionDescription");
					this.OnMCOptionDescriptionChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="MCOption_QuestionBank", Storage="_QuestionBanks", ThisKey="MCOption_ID", OtherKey="MCOption_ID")]
		public EntitySet<QuestionBank> QuestionBanks
		{
			get
			{
			...
			set
			{
				this._QuestionBanks.Assign(value);
			}
		}
		...
		{
			this.SendPropertyChanging();
			entity.MCOption = null;
		}
	}
	
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.MCQuestions")]
	public partial class MCQuestion : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private string _MCQuestionDescription;
    ...
    partial void OnMCQuestionDescriptionChanging(string value);
    partial void OnMCQuestionDescriptionChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_MCQuestion_ID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_MCQuestionDescription", DbType="VarChar(255) NOT NULL", CanBeNull=false)]
		public string MCQuestionDescription
		{
			get
			{
				return this._MCQuestionDescription;
			}
			set
			{
				if ((this._MCQuestionDescription != value))
				{
					this.OnMCQuestionDescriptionChanging(value);
					this.SendPropertyChanging();
					this._MCQuestionDescription = value;
					this.SendPropertyChanged("MCQuestionDescription");
					this.OnMCQuestionDescriptionChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="MCQuestion_QuestionBank", Storage="_QuestionBanks", ThisKey="MCQuestion_ID", OtherKey="MCQuestion_ID")]
		public EntitySet<QuestionBank> QuestionBanks
		{
			get
			{
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.SAQuestions")]
	public partial class SAQuestion : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnSAQuestion_IDChanging(int value);
    partial void OnSAQuestion_IDChanged();
    partial void OnSAQuestionDescriptionChanging(string value);
    partial void OnSAQuestionDescriptionChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_SAQuestion_ID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int SAQuestion_ID
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_SAQuestionDescription", DbType="VarChar(255) NOT NULL", CanBeNull=false)]
		public string SAQuestionDescription
		{
			get
			{
				return this._SAQuestionDescription;
			}
			set
			{
				if ((this._SAQuestionDescription != value))
				{
					this.OnSAQuestionDescriptionChanging(value);
					this.SendPropertyChanging();
					this._SAQuestionDescription = value;
					this.SendPropertyChanged("SAQuestionDescription");
					this.OnSAQuestionDescriptionChanged();
				}
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.SAResponses")]
	public partial class SAResponse : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private string _SAResponseDescription;
    ...
    partial void OnSAResponse_IDChanging(int value);
    partial void OnSAResponse_IDChanged();
    partial void OnSAResponseDescriptionChanging(string value);
    partial void OnSAResponseDescriptionChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_SAResponse_ID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int SAResponse_ID
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_SAResponseDescription", DbType="VarChar(255) NOT NULL", CanBeNull=false)]
		public string SAResponseDescription
		{
			get
			{
				return this._SAResponseDescription;
			}
			set
			{
				if ((this._SAResponseDescription != value))
				{
					this.OnSAResponseDescriptionChanging(value);
					this.SendPropertyChanging();
					this._SAResponseDescription = value;
					this.SendPropertyChanged("SAResponseDescription");
					this.OnSAResponseDescriptionChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="SAResponse_Interview", Storage="_Interviews", ThisKey="SAResponse_ID", OtherKey="SAResponse_ID")]
		public EntitySet<Interview> Interviews
		{
			get
			{
    ...
    partial void OnUserNameChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="UserProfile_Interview", Storage="_Interviews", ThisKey="UserId", OtherKey="UserID")]
		public EntitySet<Interview> Interviews
		{
			get
			{
